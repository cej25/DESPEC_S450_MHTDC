...
void EventAnlProc::Make_FRS_Histos(){
    ...
    hID_Z_Sc21E = MakeTH2('D',"FRS/ID/ID_Z1_Sc21E","ID_Z1_Sc21E", 300,0,25.,400,0,4000.,"Z s2-s4", "sqrt(Sc21_L*sC21_R)");
...
void EventAnlProc::Process_FRS_Histos(EventUnpackStore* pInput, EventAnlStore* pOutput){
    ...
    if(FRS_CORR==true) {
        ...
        for (int i=0; i<10;i++) {
            FRS_AoQ_mhtdc[i] = FRS_AoQ_corr_mhtdc[i];
        }
    }
    ...
    for(int g=0; g<MAX_FRS_GATE; g++){
        ...
        if(cID_x2AoQ[g]->Test(FRS_AoQ, FRS_ID_x2)==true){
            ...
            // dEdeg_vs_Z check
            if(cID_dEdegZ1[g]->Test(FRS_z,FRS_dEdeg)==true){
